...
- `r3-package` [ **PUBLIC** ] : Don't mind me, I'm extremely busy, I only commit when I got time.  
- `goblin-labz` [ **PRIVATE** ] : Did you really think I would make this repo public?
- `bigbrainz-vi` [ **PRIVATE** ] : Virtual Intelligence (I don't like the term AI) project for offensive cybersecurity. Isn't that cool?
